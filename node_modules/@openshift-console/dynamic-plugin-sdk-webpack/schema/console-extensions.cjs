exports.default = {
  ...
  "definitions": {
    ...
    "CatalogItemType": {
      ...
      "description": "This extension allows plugins to contribute a new type of catalog item. For example, a Helm plugin can define a new catalog item type as HelmCharts that it wants to contribute to the Software Catalog."
    },
      ...
      "properties": {
        ...
        "properties": {
          ...
          "properties": {
            ...
            "valueClassName": {
              "type": "string",
              "description": "Optional class name for the value"
            }
          },
          "required": [
            "component",
