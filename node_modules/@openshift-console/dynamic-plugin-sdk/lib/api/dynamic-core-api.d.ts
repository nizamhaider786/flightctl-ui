...
import { CodeEditorProps, CodeEditorRef, DocumentTitleProps, ErrorBoundaryFallbackProps, HorizontalNavProps, InventoryItemBodyProps, InventoryItemStatusProps, InventoryItemTitleProps, ListPageCreateButtonProps, ListPageCreateDropdownProps, ListPageCreateLinkProps, ListPageCreateProps, ListPageFilterProps, ListPageHeaderProps, NamespaceBarProps, OverviewGridProps, OverviewProps, QueryBrowserProps, ResourceEventStreamProps, ResourceIconProps, ResourceLinkProps, ResourceYAMLEditorProps, TableDataProps, TimestampProps, UseActiveColumns, UseActiveNamespace, UseAnnotationsModal, UseDeleteModal, UseLabelsModal, UseListPageFilter, UsePrometheusPoll, UseQuickStartContext, UseResolvedExtensions, UseUserSettings, VirtualizedTableFC } from '../extensions/console-types';
 ...
 */
export declare const DocumentTitle: React.FC<DocumentTitleProps>;
/**
