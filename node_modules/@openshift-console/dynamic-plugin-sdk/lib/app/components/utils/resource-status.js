...
const ResourceStatus = ({ additionalClassNames, badgeAlt, children, }) => {
    return (_jsx("span", { className: classNames('dps-resource-item__resource-status', additionalClassNames), children: _jsx(Badge, { className: classNames('dps-resource-item__resource-status-badge', {
