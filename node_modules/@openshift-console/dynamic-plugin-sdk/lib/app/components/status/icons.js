...
export const GreenCheckCircleIcon = ({ className, title, size }) => {
    const icon = (_jsx(CheckCircleIcon, { "data-test": "success-icon", className: classNames('dps-icons__green-check-icon', className), title: title }));
    if (size) {
...
export const RedExclamationCircleIcon = ({ className, title, size, }) => {
    const icon = (_jsx(ExclamationCircleIcon, { className: classNames('dps-icons__red-exclamation-icon', className), title: title }));
    if (size) {
        return _jsx(Icon, { size: size, children: icon });
    }
    return icon;
...
export const YellowExclamationTriangleIcon = ({ className, title, size, dataTest, }) => {
    const icon = (_jsx(ExclamationTriangleIcon, { className: classNames('dps-icons__yellow-exclamation-icon', className), title: title, "data-test": dataTest }));
    if (size) {
        return _jsx(Icon, { size: size, children: icon });
    }
    return icon;
...
export const BlueInfoCircleIcon = ({ className, title, size }) => {
    const icon = (_jsx(InfoCircleIcon, { className: classNames('dps-icons__blue-info-icon', className), title: title }));
    if (size) {
        return _jsx(Icon, { size: size, children: icon });
    }
    return icon;
